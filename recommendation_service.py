...
async def lifespan(app: FastAPI):
    ...
    # код ниже (до yield) выполнится только один раз при запуске сервиса
        ...
        rec_store.load(
                "personal",
                "/home/mle-user/mle_projects/mle-project-sprint-4-v001/FastAPI/recommendations_finale.parquet",
                columns=["user_id", "item_id", "rank"]
                )
        rec_store.load(
                "default",
                "/home/mle-user/mle_projects/mle-project-sprint-4-v001/FastAPI/top_popular_finale.parquet",
